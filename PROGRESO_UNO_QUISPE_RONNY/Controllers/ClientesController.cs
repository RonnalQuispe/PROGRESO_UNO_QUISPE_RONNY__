...
namespace PROGRESO_UNO_QUISPE_RONNY.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ClientesController(baseProgreso1 context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClienteId,Nombre,Saldo,FechaRegistro,Telefono,Direccion")] Cliente cliente)
        {
